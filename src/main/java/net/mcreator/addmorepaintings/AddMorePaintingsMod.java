 ...
 *
 */
package net.mcreator.addmorepaintings;
...
@Mod("add_more_paintings")
public class AddMorePaintingsMod {
	public static final Logger LOGGER = LogManager.getLogger(AddMorePaintingsMod.class);
	public static final String MODID = "add_more_paintings";

	public AddMorePaintingsMod() {
